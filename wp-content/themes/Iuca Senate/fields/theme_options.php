...
Container::make('theme_options', 'Настройки сайта')
    ...
    ->add_tab('Социальные сети - фиксированные', array(
        Field::make('complex', 'side_list_social', 'Соц.сети')
            ->add_fields(array(
                Field::make('image', 'side_icon_social', 'Иконка соц.сети')
                    ->set_width(30),
                Field::make('text', 'side_link_social', 'Введите ссылку')
                    ->set_attribute('placeholder', 'vk.com/company_group')
                    ->set_width(70),
            ))
            ->set_max(6)
